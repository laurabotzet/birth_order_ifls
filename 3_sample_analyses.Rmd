...
glm(main_sample ~ g_factor_2015_old + years_of_education, data = birthorder,
    family = binomial(link='logit'))
summary(glm(main_sample ~ g_factor_2015_old + years_of_education, data = birthorder),
    family = binomial(link='logit'))
...
glm(main_sample ~ g_factor_2015_old + years_of_education +
      poly(age, 3, raw = TRUE) + sibling_count_genes,
    data = birthorder,
    family = binomial(link='logit'),
...
glm(main_sample ~ g_factor_2015_old, data = birthorder,
    family = binomial(link='logit'))
summary(glm(main_sample ~ g_factor_2015_old, data = birthorder),
    family = binomial(link='logit'))
...
glm(main_sample ~ g_factor_2015_old +
    ...
    family = binomial(link='logit'),
    maxit = 1000)
summary(glm(main_sample ~ g_factor_2015_old +
      poly(age, 3, raw = TRUE) + sibling_count_genes,
    data = birthorder,
    family = binomial(link='logit'),
    maxit = 1000))
...
glm(main_sample ~ sibling_count_genes, data = birthorder, family = binomial(link='logit'))
summary(glm(main_sample ~ sibling_count_genes, data = birthorder, family = binomial(link='logit')))
std_beta(glm(main_sample ~ sibling_count_genes, data = birthorder, family = binomial(link='logit')))
plot(allEffects(glm(main_sample ~ sibling_count_genes, data = birthorder,
                    family = binomial(link = 'logit'))))

lm(g_factor_2015_old ~ main_sample, data = birthorder)
std_beta(lm(g_factor_2015_old ~ main_sample, data = birthorder))
std_beta(lm(g_factor_2015_old ~ main_sample + poly(age, 3, raw = T) + sibling_count_genes,
            data = birthorder))
