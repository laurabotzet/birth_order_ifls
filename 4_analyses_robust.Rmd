...
---
# <span style="color:#FFD92F">Robustness Analyses</span> {.tabset}
...
```{r  How many siblings with data do we retain in each family?}
crosstabs(~is.na(birthorder$birthorder_naive) + is.na(birthorder$g_factor_2015_old))
crosstabs(~is.na(birthorder$birthorder_uterus_preg) + is.na(birthorder$g_factor_2015_old))
