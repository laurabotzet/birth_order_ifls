...
# birthorder as factors with levels of 1, 2, 3, 4, 5, 5+
    birthorder_naive2_factor = as.character(birthorder_naive2),
    birthorder_naive2_factor = ifelse(birthorder_naive2 > 5, "5+",
                                            birthorder_naive2_factor),
    birthorder_naive2_factor = factor(birthorder_naive2_factor, 
                                            levels = c("1","2","3","4","5","5+")),
    sibling_count_naive2_factor = as.character(sibling_count_naive2),
    sibling_count_naive2_factor = ifelse(sibling_count_naive2 > 5, "5+",
                                               sibling_count_naive2_factor),
    sibling_count_naive2_factor = factor(sibling_count_naive2_factor, 
                                               levels = c("2","3","4","5","5+")),
    ...
    count_birthorder_naive2 =
      factor(str_replace(as.character(interaction(birthorder_naive2_factor,                                                              sibling_count_naive2_factor)),
                        "\\.", "/"),
...
g_factor_m1 = lmer(g_factor ~ birthorder_naive2 + birthyear + male + sibling_count_naive2 + (1 | mother_pidlink), data = birthorder)
summary(g_factor_m1)
plot(allEffects(g_factor_m1))
birthorder %>% select(g_factor, birthyear, male, birthorder_naive2_factor, mother_pidlink) %>% missingness_patterns()

g_factor_m1 = lmer(g_factor ~ birthyear + male + sibling_count + (1 | mother_pidlink),
                   data = birthorder %>%
                     rename(sibling_count = sibling_count_naive2_factor,
                            birth_order_nonlinear = birthorder_naive2_factor,
                            birth_order = birthorder_naive2,
                            count_birth_order = count_birthorder_naive2))
