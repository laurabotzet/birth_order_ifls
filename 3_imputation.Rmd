...
alldatasm = alldatasm %>% select(mother_pidlink, birthorder_genes,
                                 raven_2015_old, years_of_education, big5_ext)
...
meth1
pred1
imp1 <- mice(alldatasm, maxit=10, m=2, predictorMatrix=pred1, method=meth1)
