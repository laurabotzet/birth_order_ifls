    ...
    mutate(mother_birthdate = 
           ifelse(is.na(birth_year_m), NA,
                  ifelse(is.na(mother_pidlink), NA,
                         paste0(mother_pidlink, "-", birth_year_m))))

individuals = individuals %>%
    mutate(mother_birthdate = 
           ifelse(is.na(ar08yr), NA,
                  ifelse(is.na(mother_pidlink), NA,
                         paste0(mother_pidlink, "-", ar08yr))))


View(subset(individuals, mother_pidlink=="002040002"))
View(subset(motherinformations, mother_pidlink=="002040002"))
View(subset(parentscheck, mother_pidlink=="002040002"))


parentscheck = bind_rows(individuals, motherinformations)
##Remove duplicates
parentscheck =  parentscheck %>% distinct(mother_birthdate, .keep_all = TRUE)
