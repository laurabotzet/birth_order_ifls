...
### Main Test: G-Factor - without covariates
## Main Test: G-Factor - uterus_alive
m_g_factor_uterus_alive_no_interaction = lm(g_factor ~ birthorder_uterus_alive_factor + sibling_count_uterus_alive_factor,
                             data = alldata_birthorder)
summary(m_g_factor_uterus_alive_no_interaction)
plot_birthorder(m_g_factor_uterus_alive_no_interaction, 
                ylabel = "G factor", title = "G factor", separate = FALSE)

m_g_factor_uterus_alive = lm(g_factor ~ count_birthorder_uterus_alive,
                             data = alldata_birthorder)
anova(m_g_factor_uterus_alive_no_interaction, m_g_factor_uterus_alive)
anova(m_g_factor_uterus_alive)
plot_birthorder(m_g_factor_uterus_alive)

## Main Test: G-Factor - uterus_alive with covariates
m_g_factor_uterus_alive_covariates = lm(g_factor ~ birthorder_uterus_alive_factor  +
                             sibling_count_uterus_alive_factor 
                                       + birthyear + male,
                             data = alldata_birthorder)
anova(m_g_factor_uterus_alive_covariates)
m_g_factor_uterus_preg_covariates = lm(g_factor ~ birthorder_uterus_preg_factor  +
                             sibling_count_uterus_preg_factor 
                                       + birthyear + male,
                             data = alldata_birthorder)
anova(m_g_factor_uterus_alive_covariates)
m_g_factor_genes_covariates = lm(g_factor ~ birthorder_genes_factor  +
                             sibling_count_genes_factor 
                                       + birthyear + male,
                             data = alldata_birthorder)
anova(m_g_factor_genes_covariates)


m_g_factor_uterus_alive_covariates = lm(g_factor ~ count_birthorder_uterus_alive 
                                       + birthyear + male,
                             data = alldata_birthorder)
anova(m_g_factor_uterus_alive_covariates)
plot_birthorder(m_g_factor_uterus_alive_covariates)
...
## Main Test: G-Factor - genes with covariates
m_g_factor_genes_covariates = lm(g_factor ~ count_birthorder_genes
                                + birthyear + male,
                            data = alldata_birthorder)
summary(m_g_factor_genes_covariates)
plot_birthorder(m_g_factor_genes_covariates)
...
### Personality - without covariates
## Openness
...
m_big5_open_uterus_alive_covariates = lm(big5_open ~ birthorder_uterus_alive_factor  +
                             sibling_count_uterus_alive_factor +
                                         birthyear + male,
                            data = alldata_birthorder)
anova(m_big5_open_uterus_alive_covariates)
plot_birthorder(m_big5_open_uterus_alive_covariates)

m_big5_open_uterus_alive_covariates = lm(big5_open ~ count_birthorder_uterus_alive +
                                         birthyear + male,
                            data = alldata_birthorder)
summary(m_big5_open_uterus_alive_covariates)
plot_birthorder(m_big5_open_uterus_alive_covariates)
...
m_big5_ext_uterus_alive_covariates = lm(big5_ext ~ count_birthorder_uterus_alive +
                                         birthyear + male,
                            data = alldata_birthorder)
summary(m_big5_ext_uterus_alive_covariates)
plot_birthorder(m_big5_ext_uterus_alive_covariates)
...
m_big5_neu_uterus_alive_covariates = lm(big5_neu ~ count_birthorder_uterus_alive +
                                         birthyear + male,
                            data = alldata_birthorder)
summary(m_big5_neu_uterus_alive_covariates)
plot_birthorder(m_big5_neu_uterus_alive_covariates)
...
m_big5_agree_uterus_alive_covariates = lm(big5_agree ~ count_birthorder_uterus_alive +
                                         birthyear + male,
                            data = alldata_birthorder)
summary(m_big5_agree_uterus_alive_covariates)
plot_birthorder(m_big5_agree_uterus_alive_covariates)
...
m_big5_con_uterus_alive_covariates = lm(big5_con ~ count_birthorder_uterus_alive +
                                         birthyear + male,
                            data = alldata_birthorder)
summary(m_big5_con_uterus_alive_covariates)
plot_birthorder(m_big5_con_uterus_alive_covariates)
...
m_riskA_uterus_alive_covariates = lm(riskA ~ count_birthorder_uterus_alive +
                                         birthyear + male,
                            data = alldata_birthorder)
summary(m_riskA_uterus_alive_covariates)
plot_birthorder(m_riskA_uterus_alive_covariates)
...
m_riskB_uterus_alive_covariates = lm(riskB ~ count_birthorder_uterus_alive +
                                         birthyear + male,
                            data = alldata_birthorder)
summary(m_riskB_uterus_alive_covariates)
plot_birthorder(m_riskB_uterus_alive_covariates)
...
# With covariates
lme_g_factor_uterus_alive_covariates = lmer(g_factor ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_g_factor_uterus_alive_covariates)
plot_birthorder(lme_g_factor_uterus_alive_covariates)
...
# With covariates
lme_g_factor_uterus_preg_covariates = lmer(g_factor ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_g_factor_uterus_preg_covariates)
plot_birthorder(lme_g_factor_uterus_preg_covariates)
...
# With covariates
lme_g_factor_genes_covariates = lmer(g_factor ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_g_factor_genes_covariates)
plot_birthorder(lme_g_factor_genes_covariates)
anova(lme_g_factor_genes_covariates)
...
# With covariates
lme_raven_uterus_alive_covariates = lmer(raven ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_raven_uterus_alive_covariates)
plot_birthorder(lme_raven_uterus_alive_covariates)
...
# With covariates
lme_raven_uterus_preg_covariates = lmer(raven ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_raven_uterus_preg_covariates)
plot_birthorder(lme_raven_uterus_preg_covariates)
...
# With covariates
lme_raven_genes_covariates = lmer(raven ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_raven_genes_covariates)
plot_birthorder(lme_raven_genes_covariates)
...
# With covariates
lme_math_uterus_alive_covariates = lmer(math ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_math_uterus_alive_covariates)
plot_birthorder(lme_math_uterus_alive_covariates)
...
# With covariates
lme_math_uterus_preg_covariates = lmer(math ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_math_uterus_preg_covariates)
plot_birthorder(lme_math_uterus_preg_covariates)
...
# With covariates
lme_math_genes_covariates = lmer(math ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_math_genes_covariates)
plot_birthorder(lme_math_genes_covariates)
...
# With covariates
lme_count_backwards_uterus_alive_covariates = lmer(count_backwards ~
                                                    count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_count_backwards_uterus_alive_covariates)
plot_birthorder(lme_count_backwards_uterus_alive_covariates)
...
# With covariates
lme_count_backwards_uterus_preg_covariates = lmer(count_backwards ~
                                                   count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_count_backwards_uterus_preg_covariates)
plot_birthorder(lme_count_backwards_uterus_preg_covariates)
...
# With covariates
lme_count_backwards_genes_covariates = lmer(count_backwards ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_count_backwards_genes_covariates)
plot_birthorder(lme_count_backwards_genes_covariates)
...
# With covariates
lme_words_remembered_avg_uterus_alive_covariates = lmer(words_remembered_avg ~
                                                    count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_words_remembered_avg_uterus_alive_covariates)
plot_birthorder(lme_words_remembered_avg_uterus_alive_covariates)
...
# With covariates
lme_words_remembered_avg_uterus_preg_covariates = lmer(words_remembered_avg ~
                                                   count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_words_remembered_avg_uterus_preg_covariates)
plot_birthorder(lme_words_remembered_avg_uterus_preg_covariates)
...
# With covariates
lme_words_remembered_avg_genes_covariates = lmer(words_remembered_avg ~
                                                  count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_words_remembered_avg_genes_covariates)
plot_birthorder(lme_words_remembered_avg_genes_covariates)
...
# With covariates
lme_adaptive_numbering_uterus_alive_covariates = lmer(adaptive_numbering ~
                                                       count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_adaptive_numbering_uterus_alive_covariates)
plot_birthorder(lme_adaptive_numbering_uterus_alive_covariates)
...
# With covariates
lme_adaptive_numbering_uterus_preg_covariates = lmer(adaptive_numbering ~
                                                      count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_adaptive_numbering_uterus_preg_covariates)
plot_birthorder(lme_adaptive_numbering_uterus_preg_covariates)
...
# With covariates
lme_adaptive_numbering_genes_covariates = lmer(adaptive_numbering ~ 
                                                count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_adaptive_numbering_genes_covariates)
plot_birthorder(lme_adaptive_numbering_genes_covariates)
...
# With covariates
lme_big5_open_uterus_alive_covariates = lmer(big5_open ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_open_uterus_alive_covariates)
plot_birthorder(lme_big5_open_uterus_alive_covariates)
...
# With covariates
lme_big5_open_uterus_preg_covariates = lmer(big5_open ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_open_uterus_preg_covariates)
plot_birthorder(lme_big5_open_uterus_preg_covariates)
...
# With covariates
lme_big5_open_genes_covariates = lmer(big5_open ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_open_genes_covariates)
plot_birthorder(lme_big5_open_genes_covariates)
...
# With covariates
lme_big5_ext_uterus_alive_covariates = lmer(big5_ext ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_ext_uterus_alive_covariates)
plot_birthorder(lme_big5_ext_uterus_alive_covariates)
...
# With covariates
lme_big5_ext_uterus_preg_covariates = lmer(big5_ext ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_ext_uterus_preg_covariates)
plot_birthorder(lme_big5_ext_uterus_preg_covariates)
...
# With covariates
lme_big5_ext_genes_covariates = lmer(big5_ext ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_ext_genes_covariates)
plot_birthorder(lme_big5_ext_genes_covariates)
...
# With covariates
lme_big5_neu_uterus_alive_covariates = lmer(big5_neu ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_neu_uterus_alive_covariates)
plot_birthorder(lme_big5_neu_uterus_alive_covariates)
...
# With covariates
lme_big5_neu_uterus_preg_covariates = lmer(big5_neu ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_neu_uterus_preg_covariates)
plot_birthorder(lme_big5_neu_uterus_preg_covariates)
...
# With covariates
lme_big5_neu_genes_covariates = lmer(big5_neu ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_neu_genes_covariates)
plot_birthorder(lme_big5_neu_genes_covariates)
...
# With covariates
lme_big5_agree_uterus_alive_covariates = lmer(big5_agree ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_agree_uterus_alive_covariates)
plot_birthorder(lme_big5_agree_uterus_alive_covariates)
...
# With covariates
lme_big5_agree_uterus_preg_covariates = lmer(big5_agree ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_agree_uterus_preg_covariates)
plot_birthorder(lme_big5_agree_uterus_preg_covariates)
...
# With covariates
lme_big5_agree_genes_covariates = lmer(big5_agree ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_agree_genes_covariates)
plot_birthorder(lme_big5_agree_genes_covariates)
...
# With covariates
lme_big5_con_uterus_alive_covariates = lmer(big5_con ~ count_birthorder_uterus_alive +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_con_uterus_alive_covariates)
plot_birthorder(lme_big5_con_uterus_alive_covariates)
...
# With covariates
lme_big5_con_uterus_preg_covariates = lmer(big5_con ~ count_birthorder_uterus_preg +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_con_uterus_preg_covariates)
plot_birthorder(lme_big5_con_uterus_preg_covariates)
...
# With covariates
lme_big5_con_genes_covariates = lmer(big5_con ~ count_birthorder_genes +
                                             (1 | mother_pidlink) + birthyear + male,
                                           data = alldata_birthorder)
summary(lme_big5_con_genes_covariates)
plot_birthorder(lme_big5_con_genes_covariates)
```
