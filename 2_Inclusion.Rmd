...
missingness_patterns(alldata_birthorder %>% select(highest_education))

alldata_birthorder = alldata_birthorder %>%
  mutate(used_ea = ifelse(!is.na(highest_education), 1, 0))
                        ...
                        ifelse(!is.na(riskA), 1,
                               ifelse(!is.na(riskB), 1,
                                      ifelse(!is.na(big5_ext), 1,
                                             ifelse(!is.na(highest_education), 1, 0))))),
         group = "test",
