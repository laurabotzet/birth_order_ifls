...
fa(alldata_birthorder %>% select(raven_2015_old, math_2015_old, count_backwards, words_delayed, adaptive_numbering) %>% data.frame(), nfactors = 3)
om_results = omega(alldata_birthorder %>% select(raven_2015_old, math_2015_old, count_backwards, words_delayed, adaptive_numbering) %>% data.frame(), nfactors = 3, sl = F)
om_results
...
cor.test(predict(cfa_g)[,1], alldata_birthorder %>% select(raven_2015_old, math_2015_old, count_backwards,  words_delayed, adaptive_numbering) %>% scale() %>% rowMeans())
...
cor.test(predict(cfa_g)[,1], alldata_birthorder %>% select(raven_2015_old, math_2015_old, count_backwards,  words_delayed, adaptive_numbering) %>% scale() %>% rowMeans())
cor.test(predict(cfa_g)[,2], alldata_birthorder %>% select(raven_2007_old, math_2007_old) %>% scale() %>% rowMeans())
...
fa(no_miss %>% select(raven_2015_old, math_2015_old, count_backwards, words_delayed, adaptive_numbering) %>% data.frame(), nfactors = 2)
