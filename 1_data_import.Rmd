...
bek_ek2 = read_dta("data/hh07_all_dta/bek_ek2.dta") # Intelligence information from wave 4 (2007)
...
child_labour_missed = child_labour %>%
  ...
  mutate(total_missed = ifelse(Elementary_missed == 1 | Junior_high_missed == 1 |
         ...
         total_missed = ifelse(is.na(total_missed), 0, total_missed))
...
smoking = b3b_km %>%
  ...
  mutate(ever_smoked = ifelse(ever_smoked == 1, 1, 0),
         ...
         still_smoking = ifelse(is.na(still_smoking), 0, still_smoking),
