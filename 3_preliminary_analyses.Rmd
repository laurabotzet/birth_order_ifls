...
plot_birthorder = function(model, ylabel, bo_var = "birthorder") {
  ...
  plotx = ggplot(cemm, aes(`Birth order`, y = fit, ymax = upper, ymin = lower,
    ...
    scale_y_continuous(name=ylabel, limits = c(-0.6, 0.6), breaks = c(-0.6, -0.4, -0.2, 0,
                                                                  0.2, 0.4, 0.6)) +
    apatheme +
    theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) +
    guides(colour=guide_legend(title = "Sibship Size.....n"))
  print(plotx)
...
plot_big5_open
 ...
 plot_grid(plot_g_factor, plot_big5_open, labels = c("a", "b"), nrwo=2, align=hv)
```
