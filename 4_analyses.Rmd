...
alldata_birthorder = alldata_birthorder %>%
  mutate(
    ...
    # center birthyear
    birthyear = birth_year - mean(birth_year, na.rm = T),
    # Sex (1 = male, 2 = female)
...
```{r}
raven_preg_m1 = lmer(raven ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
math_preg_m1 = lmer(math ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
count_backwards_preg_m1 = lmer(count_backwards ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
                      rename(sibling_count = sibling_count_uterus_preg_factor,
                             birth_order_nonlinear = birthorder_uterus_preg_factor,
                             birth_order = birthorder_uterus_preg,
                             count_birth_order = count_birthorder_uterus_preg
...
```{r}
words_immediate_preg_m1 = lmer(words_immediate ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
                                 rename(sibling_count = sibling_count_uterus_preg_factor,
                                        birth_order_nonlinear = birthorder_uterus_preg_factor,
                                        birth_order = birthorder_uterus_preg,
                                        count_birth_order = count_birthorder_uterus_preg
...
```{r}
words_delayed_preg_m1 = lmer(words_delayed ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
                                 rename(sibling_count = sibling_count_uterus_preg_factor,
                                        birth_order_nonlinear = birthorder_uterus_preg_factor,
                                        birth_order = birthorder_uterus_preg,
                                        count_birth_order = count_birthorder_uterus_preg
...
```{r}
adaptive_numbering_preg_m1 = lmer(adaptive_numbering ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
                                 rename(sibling_count = sibling_count_uterus_preg_factor,
                                        birth_order_nonlinear = birthorder_uterus_preg_factor,
                                        birth_order = birthorder_uterus_preg,
                                        count_birth_order = count_birthorder_uterus_preg
...
```{r}
big5_ext_preg_m1 = lmer(big5_ext ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
big5_neu_preg_m1 = lmer(big5_neu ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
big5_con_preg_m1 = lmer(big5_con ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
big5_agree_preg_m1 = lmer(big5_agree ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
big5_open_preg_m1 = lmer(big5_open ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
riskA_preg_m1 = lmer(riskA ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
...
```{r}
riskB_preg_m1 = lmer(riskB ~ birthyear + male + sibling_count + (1 | mother_pidlink), data = alldata_birthorder %>% 
  rename(sibling_count = sibling_count_uterus_preg_factor,
         birth_order_nonlinear = birthorder_uterus_preg_factor,
         birth_order = birthorder_uterus_preg,
         count_birth_order = count_birthorder_uterus_preg
