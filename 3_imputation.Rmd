...
alldata_birthorder = alldata_birthorder %>%
  select(-pidlink, -Category, -Sector) %>%
...
predictor_matrix[, "mother_pidlink"] = -2
...
method[2:60] = "2l.norm" # variables that can not be predicted by multilevel modelling, will be predicted # by predictive mean matching (default)
# method[8] = "2l.norm" # we have to specify which variables shoul be predicted by multilevel modelling
