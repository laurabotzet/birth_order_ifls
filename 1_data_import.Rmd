...
pregnancy$mother_pidlink = pregnancy$mother_pidlink.x
...
length(intersect(marriage$pidlink, pregnancy$mother_pidlink))
length(setdiff(pregnancy$mother_pidlink, marriage$pidlink))
length(setdiff(marriage$pidlink, pregnancy$mother_pidlink))
...
table(is.na(pregnancy$marriage_id))
...
alldata_pregnancy = alldata_pregnancy %>%
  ...
  group_by(marriage_id) %>%
    mutate(birthorder_genes = min_rank(birthdate),
           ...
           sibling_count_genes = sum(!is.na(marriage_id)))
